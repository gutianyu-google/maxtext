...
def preprocess_mm_data(config):
  ...
  elif vision_block in ["qwen3_omni", "qwen3_vl", "qwen3_5", "cosmos3-nano-reasoner", "cosmos3-super-reasoner"]:
...
def reformat_response(response, model_name):
  ...
  if decoder_block in ["llama4"]:
    ...
    return formatted_response
  elif decoder_block in ["qwen3", "qwen3_moe", "qwen3_5", "cosmos3-nano-reasoner", "cosmos3-super-reasoner"]:
